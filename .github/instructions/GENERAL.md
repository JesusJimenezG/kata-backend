...
- Persistence is JPA-focused (Spring Data JPA + Hibernate). Do not use JDBC unless explicitly requested.
...
- Spring Security is on the classpath; assume endpoints may need security configuration when added. JWT is preferred for session management.
